      ...
      <CardContent className="p-0">
        <Table className="min-w-[1120px] table-fixed">
          ...
          <TableBody>
            ...
            {loading ? <ProjectTableState colSpan={9}><Loader2 className="animate-spin" />正在加载...</ProjectTableState> : null}
            {!loading && !projects?.items.length ? <ProjectTableState colSpan={9}>暂无研究项目</ProjectTableState> : null}
          </TableBody>
        </Table>
      </CardContent>
    </Card>
