...
function WorkflowRow({ now, onDetails, onLogs, onStop, projectId, showUsername, stopping, workflow }: { now: number; onDetails: () => void; onLogs: (taskInstanceId: number) => void; onStop: () => void; projectId: number | null; showUsername: boolean; stopping: boolean; workflow: WorkflowListItem }) {
